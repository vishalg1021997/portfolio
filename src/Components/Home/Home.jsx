...
import photo from "../../logo/vishal.png"
		...
		<div ref={scrollRef}>
			...
			>
				...
				>
					...
					<h1>
						I am a Frontend Web Developer based in Mumbai. I build
						things for web.
					</h1>
					<div className={styles.btn}>
						
						<a href='https://drive.google.com/file/d/1f5YCb4ws9Yt48krRhv9nf8iDfx26L_t1/view?usp=sharing' target='_blank' rel='noopener noreferrer'>
							<Button
								text={
				...
				>
					<img
						...
						alt='Profile pic' style={{height: '100%',width: '100%'}}
					/>
				</div>
			</div>
